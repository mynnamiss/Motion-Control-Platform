...
if(buttonstate1 == HIGH){state = 1;}
else if (buttonstate2 == HIGH){state = 2;}
else if (buttonstate3 == HIGH){state = 3;}
else{state = 0;}
//   //Serial.read();//here we're going to control using the serial monitor until Octavio gets the app running
    if (state == 1)
        {
