...
Servo backDoor1, backDoor2, frontWheel, wheel1, wheel2;
...
void loop() {
  ...
  initialization(); delay(1000);}
    ...
    Serial.println("Landing gear up");
    landing_up(); delay(1000);}
  else if (state == 'g'){
    Serial.println("Landing gear down");
    landing_down();delay(1000);}
    else if (state == 'Z') {
...
void initialization(){
 ...
 while  (counter >=40000 && counter<45000){
  digitalWrite(DIR, LOW);   digitalWrite(PUL, HIGH); 
  digitalWrite(DIR6, HIGH); digitalWrite(PUL6, HIGH); 
  delayMicroseconds(700);
  digitalWrite(PUL, LOW);   digitalWrite(PUL2, LOW);
  ...
  while (innerstate != '0'){
    innerstate = Serial.read();}
 while(counter>=45000&& counter <=85000){
  digitalWrite(DIR2,HIGH);  digitalWrite(PUL2, HIGH);
  digitalWrite(DIR5,LOW);   digitalWrite(PUL5, HIGH);
  digitalWrite(DIR3, LOW);  digitalWrite(PUL3, HIGH);
  digitalWrite(DIR4, HIGH); digitalWrite(PUL4, HIGH);
  delayMicroseconds(700);   digitalWrite(PUL3, LOW);digitalWrite(PUL4, LOW); counter++;}   
  }
